...
const AgiCustomPatternSensorPacket: LvtNodeDef = {
  _id: "AgiCustomPatternSensorPacket",
  ui: {
    title: "AgiCustomPatternSensorPacket",
    description: "Describes the graphical properties of a single Agi Custom Pattern Scnsor in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "AgiCustomPatternSensorPacket",
      dataType: "AgiCustomPatternSensorPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _orientation: any, _viewFrom: any, _agi_customPatternSensor: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _orientation, _viewFrom, _agi_customPatternSensor }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "AgiCustomPatternSensorPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "orientation", "viewFrom", "agi_customPatternSensor"]);
    return node;
  },
};

export default AgiCustomPatternSensorPacket;