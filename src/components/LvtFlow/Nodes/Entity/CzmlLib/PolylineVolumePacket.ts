...
const PolylineVolumePacket: LvtNodeDef = {
  _id: "PolylineVolumePacket",
  ui: {
    title: "PolylineVolumePacket",
    description: "Describes the graphical properties of a single Polyline Volume in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "PolylineVolumePacket",
      dataType: "PolylineVolumePacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _viewFrom: any, _polylineVolume: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _viewFrom, _polylineVolume }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "PolylineVolumePacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "viewFrom", "polylineVolume"]);
    return node;
  },
};

export default PolylineVolumePacket;