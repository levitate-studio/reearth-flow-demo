...
const ModelPacket: LvtNodeDef = {
  _id: "ModelPacket",
  ui: {
    title: "ModelPacket",
    description: "Describes the graphical properties of a single Model in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "ModelPacket",
      dataType: "ModelPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _orientation: any, _viewFrom: any, _model: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _orientation, _viewFrom, _model }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "ModelPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "orientation", "viewFrom", "model"]);
    return node;
  },
};

export default ModelPacket;