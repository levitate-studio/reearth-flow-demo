...
const WallPacket: LvtNodeDef = {
  _id: "WallPacket",
  ui: {
    title: "WallPacket",
    description: "Describes the graphical properties of a single Wall in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _viewFrom: any, _wall: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _viewFrom, _wall }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "WallPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "viewFrom", "wall"]);
    return node;
  },
};

export default WallPacket;