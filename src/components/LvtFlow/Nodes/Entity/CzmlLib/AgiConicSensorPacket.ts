...
const AgiConicSensorPacket: LvtNodeDef = {
  _id: "AgiConicSensorPacket",
  ui: {
    title: "AgiConicSensorPacket",
    description: "Describes the graphical properties of a single Agi Conic Sensor in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "AgiConicSensorPacket",
      dataType: "AgiConicSensorPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _orientation: any, _viewFrom: any, _agi_conicSensor: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _orientation, _viewFrom, _agi_conicSensor }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "AgiConicSensorPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "orientation", "viewFrom", "agi_conicSensor"]);
    return node;
  },
};

export default AgiConicSensorPacket;