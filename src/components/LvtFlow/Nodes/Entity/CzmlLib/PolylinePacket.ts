...
const PolylinePacket: LvtNodeDef = {
  _id: "PolylinePacket",
  ui: {
    title: "PolylinePacket",
    description: "Describes the graphical properties of a single Polyline in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "PolylinePacket",
      dataType: "PolylinePacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _viewFrom: any, _polyline: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _viewFrom, _polyline }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "PolylinePacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "viewFrom", "polyline"]);
    return node;
  },
};

export default PolylinePacket;