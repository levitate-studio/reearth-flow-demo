...
const EllipsoidPacket: LvtNodeDef = {
  _id: "EllipsoidPacket",
  ui: {
    title: "EllipsoidPacket",
    description: "Describes the graphical properties of a single Ellipsoid in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "EllipsoidPacket",
      dataType: "EllipsoidPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _orientation: any, _viewFrom: any, _ellipsoid: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _orientation, _viewFrom, _ellipsoid }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "EllipsoidPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "orientation", "viewFrom", "ellipsoid"]);
    return node;
  },
};

export default EllipsoidPacket;