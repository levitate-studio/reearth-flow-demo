...
const LabelPacket: LvtNodeDef = {
  _id: "LabelPacket",
  ui: {
    title: "LabelPacket",
    description: "Describes the graphical properties of a single Label in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "LabelPacket",
      dataType: "LabelPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _viewFrom: any, _label: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _viewFrom, _label }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "LabelPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "viewFrom", "label"]);
    return node;
  },
};

export default LabelPacket;