...
const RectanglePacket: LvtNodeDef = {
  _id: "RectanglePacket",
  ui: {
    title: "RectanglePacket",
    description: "Describes the graphical properties of a single Rectangle in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "RectanglePacket",
      dataType: "RectanglePacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _viewFrom: any, _rectangle: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _viewFrom, _rectangle }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "RectanglePacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "viewFrom", "rectangle"]);
    return node;
  },
};

export default RectanglePacket;