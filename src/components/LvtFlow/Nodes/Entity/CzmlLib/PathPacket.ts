...
const PathPacket: LvtNodeDef = {
  _id: "PathPacket",
  ui: {
    title: "PathPacket",
    description: "Describes the graphical properties of a single Path in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _viewFrom: any, _path: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _viewFrom, _path }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "PathPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "viewFrom", "path"]);
    return node;
  },
};

export default PathPacket;