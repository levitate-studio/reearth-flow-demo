...
const BoxPacket: LvtNodeDef = {
  _id: "BoxPacket",
  ui: {
    title: "BoxPacket",
    description: "Describes the graphical properties of a single Box in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _orientation: any, _viewFrom: any, _box: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _orientation, _viewFrom, _box }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "BoxPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "orientation", "viewFrom", "box"]);
    return node;
  },
};

export default BoxPacket;