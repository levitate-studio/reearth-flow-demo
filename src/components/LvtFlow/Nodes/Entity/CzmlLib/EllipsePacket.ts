...
const EllipsePacket: LvtNodeDef = {
  _id: "EllipsePacket",
  ui: {
    title: "EllipsePacket",
    description: "Describes the graphical properties of a single Ellipse in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "EllipsePacket",
      dataType: "EllipsePacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _viewFrom: any, _ellipse: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _viewFrom, _ellipse }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "EllipsePacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "viewFrom", "ellipse"]);
    return node;
  },
};

export default EllipsePacket;