...
const TilesetPacket: LvtNodeDef = {
  _id: "TilesetPacket",
  ui: {
    title: "TilesetPacket",
    description: "Describes the graphical properties of a single Tileset in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "TilesetPacket",
      dataType: "TilesetPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _viewFrom: any, _tileset: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _viewFrom, _tileset }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "TilesetPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "viewFrom", "tileset"]);
    return node;
  },
};

export default TilesetPacket;