...
const BillboradPacket: LvtNodeDef = {
  _id: "BillboradPacket",
  ui: {
    title: "BillboradPacket",
    description: "Describes the graphical properties of a single Billboard in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "BillboradPacket",
      dataType: "BillboradPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _viewFrom: any, _billboard: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _viewFrom, _billboard }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "BillboradPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "viewFrom", "billboard"]);
    return node;
  },
};

export default BillboradPacket;