...
const AgiVectorPacket: LvtNodeDef = {
  _id: "AgiVectorPacket",
  ui: {
    title: "AgiVectorPacket",
    description: "Describes the graphical properties of a single Agi Vector in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "AgiVectorPacket",
      dataType: "AgiVectorPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _viewFrom: any, _agi_vector: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _viewFrom, _agi_vector }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "AgiVectorPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "viewFrom", "agi_vector"]);
    return node;
  },
};

export default AgiVectorPacket;