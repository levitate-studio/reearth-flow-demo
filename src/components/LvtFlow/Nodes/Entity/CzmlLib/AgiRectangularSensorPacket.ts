...
const AgiRectangularSensorPacket: LvtNodeDef = {
  _id: "AgiRectangularSensorPacket",
  ui: {
    title: "AgiRectangularSensorPacket",
    description: "Describes the graphical properties of a single Agi Rectangular Sensor in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "AgiRectangularSensorPacket",
      dataType: "AgiRectangularSensorPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _position: any, _orientation: any, _viewFrom: any, _agi_rectangularSensor: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _position, _orientation, _viewFrom, _agi_rectangularSensor }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "AgiRectangularSensorPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "position", "orientation", "viewFrom", "agi_rectangularSensor"]);
    return node;
  },
};

export default AgiRectangularSensorPacket;