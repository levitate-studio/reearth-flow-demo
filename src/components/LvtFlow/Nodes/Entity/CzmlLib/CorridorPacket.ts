...
const CorridorPacket: LvtNodeDef = {
  _id: "CorridorPacket",
  ui: {
    title: "CorridorPacket",
    description: "Describes the graphical properties of a single Corridor in a scene.",
  },
  portsIn: [
    {
      name: "id",
  ...
  portsOut: [
    {
      name: "CorridorPacket",
      dataType: "CorridorPacket",
    },
  ],
  rule: (_id: any, _delete: any, _name: any, _parent: any, _description: any, _availability: any, _properties: any, _viewFrom: any, _corridor: any) => {
    return packageSpreadValue(
      { _id, _delete, _name, _parent, _description, _availability, _properties, _viewFrom, _corridor }
    );
  },
  update: (node: LvtNode) => {
    updateNode(node, "CorridorPacket", ["id", "delete", "name", "parent", "description", "availability", "properties", "viewFrom", "corridor"]);
    return node;
  },
};

export default CorridorPacket;